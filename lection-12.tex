...
\begin{frame}{}
\begin{center}
{\LARGE Ещё о равенстве\\Парадокс Жирара}
\end{center}
\end{frame}
...
\begin{dfn}Множества $(A,\prec)$ и $(B,\sqsubset)$ имеют одинаковый \emph{порядковый тип}, 
если существует биекция между ними, сохраняющая порядок:
\vspace{-0.3cm}
$$\forall a\in A.\forall b \in A.a \prec b \leftrightarrow f(a) \sqsubset f(b)$$
\end{dfn}
\vspace{-0.3cm}

Мы будем отождествлять порядковый тип вполне упорядоченного множества и некоторый ординал
(мы знаем, что он всегда существует и единственен).

\begin{dfn}Операции перехода от множества к порядковому типу и назад:
\begin{enumerate}
...
Заметим, что (здесь $X$ --- некоторое транзитивное множество ординалов):
...
\begin{dfn}\emph{Булеан} множества $S$ (power set) --- множество всех предикатов на $S$:
...
\begin{dfn} Рассмотрим универсум $\mathcal{U}$. Индуктивность множеств и фундированность:
...
\begin{dfn} Фиксируем некоторый универсум $\langle\mathcal{U},\sigma,\tau\rangle$. Тогда $\Omega = \tau\{x | x \text{ фундирован}, x\in\mathcal{U}\}$ --- 
